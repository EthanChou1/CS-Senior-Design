...
#include "/home/ethan/opencv_build/opencv/../opencv_contrib/modules/bgsegm/include/opencv2/bgsegm.hpp"
...
JNIEXPORT void JNICALL Java_org_opencv_bgsegm_BackgroundSubtractorGMG_apply_10 (JNIEnv*, jclass, jlong, jlong, jlong, jdouble);

JNIEXPORT void JNICALL Java_org_opencv_bgsegm_BackgroundSubtractorGMG_apply_10
  (JNIEnv* env, jclass , jlong self, jlong image_nativeObj, jlong fgmask_nativeObj, jdouble learningRate)
{
    using namespace cv::bgsegm;
    static const char method_name[] = "bgsegm::apply_10()";
...
JNIEXPORT void JNICALL Java_org_opencv_bgsegm_BackgroundSubtractorGMG_apply_11 (JNIEnv*, jclass, jlong, jlong, jlong);

JNIEXPORT void JNICALL Java_org_opencv_bgsegm_BackgroundSubtractorGMG_apply_11
  (JNIEnv* env, jclass , jlong self, jlong image_nativeObj, jlong fgmask_nativeObj)
{
    using namespace cv::bgsegm;
    static const char method_name[] = "bgsegm::apply_11()";
...
JNIEXPORT void JNICALL Java_org_opencv_bgsegm_BackgroundSubtractorGMG_getBackgroundImage_10 (JNIEnv*, jclass, jlong, jlong);

JNIEXPORT void JNICALL Java_org_opencv_bgsegm_BackgroundSubtractorGMG_getBackgroundImage_10
  (JNIEnv* env, jclass , jlong self, jlong backgroundImage_nativeObj)
{
    using namespace cv::bgsegm;
    static const char method_name[] = "bgsegm::getBackgroundImage_10()";
